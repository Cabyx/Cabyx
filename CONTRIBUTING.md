Contributing to Cabyx
============================

The Cabyx project operates an open contributor model where anyone is
...
The following applies to code changes to the Cabyx project, and is not to be
confused with overall CABYX Network Protocol consensus changes.

Whether a pull request is merged into Cabyx rests with the project merge
...
Patches that change CABYX consensus rules are considerably more involved than
...
Where a patch set proposes to change the CABYX consensus, it must have been
...
The project leader is the release manager for each Cabyx release.
