...
This means one can have an always-on cabyxd instance running, and another local cabyxd/cabyx-qt instance which connects to this node and receives blocks from it.
