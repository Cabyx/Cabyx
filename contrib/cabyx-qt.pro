...
RESOURCES += src/qt/cabyx.qrc src/qt/cabyx_locale.qrc

TRANSLATIONS += src/qt/locale/cabyx_bg.ts \
                src/qt/locale/cabyx_de.ts \
                src/qt/locale/cabyx_en.ts \
                src/qt/locale/cabyx_es.ts \
                src/qt/locale/cabyx_fi.ts \
                src/qt/locale/cabyx_fr.ts \
                src/qt/locale/cabyx_it.ts \
                src/qt/locale/cabyx_ja.ts \
                src/qt/locale/cabyx_pl.ts \
                src/qt/locale/cabyx_pt.ts \
                src/qt/locale/cabyx_ru.ts \
                src/qt/locale/cabyx_sk.ts \
                src/qt/locale/cabyx_sv.ts \
                src/qt/locale/cabyx_vi.ts \
                src/qt/locale/cabyx_zh_CN.ts \
                src/qt/locale/cabyx_zh_TW.ts
