...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cabyx cabyx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cabyx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cabyx transaction") + "\n" +
                               "  cabyx-tx [options] -create [commands]   " + _("Create hex-encoded cabyx transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cabyx transaction
