...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cabyx features */
        {"cabyx", "masternode", &masternode, true, true, false},
        {"cabyx", "listmasternodes", &listmasternodes, true, true, false},
        {"cabyx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cabyx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cabyx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cabyx", "masternodedebug", &masternodedebug, true, true, false},
        {"cabyx", "startmasternode", &startmasternode, true, true, false},
        {"cabyx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cabyx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cabyx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cabyx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cabyx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cabyx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cabyx", "mnbudget", &mnbudget, true, true, false},
        {"cabyx", "preparebudget", &preparebudget, true, true, false},
        {"cabyx", "submitbudget", &submitbudget, true, true, false},
        {"cabyx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cabyx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cabyx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cabyx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cabyx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cabyx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cabyx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cabyx", "checkbudgets", &checkbudgets, true, true, false},
        {"cabyx", "mnsync", &mnsync, true, true, false},
        {"cabyx", "spork", &spork, true, true, false},
        {"cabyx", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cabyx", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cabyxd, or the -server option to cabyx-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cabyx-cli " + methodname + " " + args + "\n";
}
