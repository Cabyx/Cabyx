...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CABYX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cabyx: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cabyx"), this);
    aboutAction->setStatusTip(tr("Show information about Cabyx"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CABYX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CABYX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CABYX addresses"));
    ...
    openAction->setStatusTip(tr("Open a CABYX: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cabyx help message to get a list with possible CABYX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cabyx client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CABYX network", "", count));
}
...
{
    QString strTitle = tr("Cabyx"); // default title
