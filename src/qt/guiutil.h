...
/** Utility functions used by the CABYX Qt UI.
 */
namespace GUIUtil
{
...
// Render CABYX addresses in monospace font
...
// Parse "cabyx:" URI into recipient object, return true on successful parsing
