/* src/config/cabyx-config.h.  Generated from cabyx-config.h.in by configure.  */
/* src/config/cabyx-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Cabyx_CONFIG_H

#define Cabyx_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.cabyx.co"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Cabyx Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Cabyx Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cabyx"
