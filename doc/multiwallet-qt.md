...
In order to support loading of multiple wallets in cabyx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cabyx.cpp.
...
Changes to cabyx.cpp
----------------------
cabyx.cpp is the entry point into cabyx-qt, and as such, will require some minor modifications to provide hooks for
